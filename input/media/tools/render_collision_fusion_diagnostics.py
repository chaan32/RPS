...
from input.media.tools.check_blindspot_recording import FrameSource, make_writer  # noqa: E402
from input.media.tools.render_blindspot_bev import (  # noqa: E402
    add_title,
...
def render_scenario(
    ...
    fieldnames = [
        ...
        "worker_forklift_dist", "worker_dropzone_dist",
        ...
        with risk_csv.open("w", newline="") as f:
            ...
            while True:
                ...
                if forklift_xy is not None:
                    ...
                    forklift_motion.update(time_s, forklift_xy)
                ...
                risks_for_frame, dz_forced = force_dropzone_alerts(
                    risks_for_frame, workers_xy, smoothed_dz,
                )
                ...
                if any(ew.level == "danger" for ew in early_warnings.values()):
...
def main() -> None:
    ...
    with summary_path.open("w", newline="") as f:
        fieldnames = [
            ...
            "min_worker_forklift_dist", "min_worker_dropzone_dist",
