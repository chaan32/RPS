...
사용법:
    python input/media/tools/test/verify_homography.py --cam cam1 --image snapshot.jpg
    python input/media/tools/test/verify_homography.py --cam cam1 --image snapshot.jpg --interactive
...
# input/media/tools/test 아래에 있으므로 parents[4]가 프로젝트 루트다.
