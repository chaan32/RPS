"""두 대의 RTSP 카메라를 YOLO 없이 하나의 창에 나란히 표시하는 진단 스크립트.

흐름:
    1. 프로젝트 루트의 .env 에서 CAMERA_RTSP_URL_1/2 를 읽는다.
    2. input.media.camera.VideoStream 으로 두 RTSP 입력을 연다.
    3. 두 프레임을 같은 크기로 맞춰 한 창에 표시한다.
"""
...
from input.media.camera import VideoStream  # noqa: E402
